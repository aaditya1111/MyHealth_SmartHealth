...
<body>
    ...
    <div class="w3l-login-form">
        <h2 style="text-decoration-color: #C09DA4">Hospital-Admin Login</h2>
        <form action="plogin.php" method="POST">
            ...
            <div class="w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control" name="mail" placeholder="email@example.com" required="required" />
                </div>
            </div>
            <div class="w3l-form-group">
          ...
          <p class="w3l-register-p">Login as<a href="login.php" class="register"> Patient</a></p>
